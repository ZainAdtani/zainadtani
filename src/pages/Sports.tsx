...
export default function Sports() {
    ...
    try {
      ...
      parsed.sort((a, b) => {
        const rank = (g: LiveGame) =>
          g.statusType === "STATUS_IN_PROGRESS" ? 0 :
          g.statusType === "STATUS_SCHEDULED"   ? 1 :
          g.statusType === "STATUS_FINAL"       ? 2 : 3;
  ...
  return (
    <div
      ...
      `}
    >
      <Helmet><title>Sports | Zain Adtani</title></Helmet>
      ...
      {showBall && (
        <div
          ...
          style={{ width: 56, height: 56, animation: "bounceBall 1.2s ease-in-out infinite", filter: "drop-shadow(0 6px 10px rgba(0,0,0,.15))" }}
          title="🏀"
        >
