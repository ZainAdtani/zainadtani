...
import { Gamepad2, Music, BookOpen, Users, Play, Rocket, Sparkles, Award, ChevronRight, FileText } from "lucide-react";
...
const EnrolledAgent = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Compact Tax Quest CTA banner */}
      <section className="container mx-auto px-4 -mt-8 mb-8 relative z-20">
        <div className="max-w-3xl mx-auto">
          <Card className="p-4 md:p-6 border border-primary/30 bg-card/95 backdrop-blur-sm shadow-lg">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl font-bold text-foreground">Turn EA Prep into a Game</h2>
                <p className="text-sm text-muted-foreground max-w-xl">
                  Clear micro stages, earn streaks, and train exam reflexes with Tax Quest.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2 min-w-[180px]">
                ...
                <p className="text-[11px] text-muted-foreground text-center">No login needed. Mobile friendly.</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Step by step lessons, walkthroughs, and practice that match the EA Part 1 blueprint.
              </p>

              <div className="space-y-2 pt-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-secondary" />
                  <span>Cinematic video modules for each domain</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-secondary" />
                  <span>Downloadable study guides and checklists</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-secondary" />
                  <span>Exam style practice questions and drills</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-secondary" />
                  <span>Audio and flashcard decks for on the go review</span>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 pt-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span>Q and A threads and breakdowns</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-primary" />
                  <span>Accountability posts and study logs</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-primary" />
                  <span>Curated links, worksheets, and tools</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-primary" />
                  <span>Announcements for new lessons and updates</span>
                </div>
              </div>
      ...
      {/* Study Soundtracks full width */}
      <section id="study-soundtracks" className="bg-muted/40 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <Card className="relative border-2 border-dashed border-accent/40 p-8 md:p-10 hover:border-accent transition-all hover-lift bg-card">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground max-w-2xl">
                  Use focused playlists that match each EA part. Pick a track, lock in, and stay with a single chapter
                  at a time.
                </p>
                  ...
                  {playlists.map((playlist) => (
                    <div key={playlist.id} className="space-y-3">
                      <Button
                        ...
                        onClick={() => setPlayingPlaylist(playingPlaylist === playlist.id ? null : playlist.id)}
                      >
          ...
          <Card className="rounded-2xl shadow-lg border-2 border-primary/20 p-8 bg-card ea-domains-accordion">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Skim the overview, then dive into the lessons when you are ready.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <Card className="rounded-2xl shadow-lg border-2 border-primary/20 p-8 bg-card ea-domains-accordion">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Quick overview of business tax areas you will see on the exam.
              </p>
            </div>
              ...
              >
                ...
                <AccordionContent className="pt-2 pb-4 space-y-3">
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-relaxed">
                    ...
                    <li>Entity selection considerations and elections (2553, 8832)</li>
                  </ul>
                  <a href="#" className="inline-flex items-center gap-2 text-primary hover:underline mt-4 font-medium">
                    <FileText className="w-4 h-4" />
                    View sample lesson →
              ...
              >
                ...
                <AccordionContent className="pt-2 pb-4 space-y-3">
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-relaxed">
                    ...
                    <li>Ordinary and necessary expenses, Section 162</li>
              ...
              >
                ...
                <AccordionContent className="pt-2 pb-4 space-y-3">
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-relaxed">
                    ...
                    <li>Common business credits (WOTC, R and D basics)</li>
                  </ul>
                  <a href="#" className="inline-flex items-center gap-2 text-primary hover:underline mt-4 font-medium">
                    <FileText className="w-4 h-4" />
                    View sample lesson →
        ...
        <div className="max-w-7xl mx-auto">
          <Card className="rounded-2xl shadow-lg border-2 border-primary/20 p-8 bg-card ea-domains-accordion">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">Key areas for representation, ethics, and IRS procedure.</p>
            </div>
              ...
              >
                ...
                <AccordionContent className="pt-2 pb-4 space-y-3">
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-relaxed">
                    ...
                    <li>Practice before the IRS, rights and limitations</li>
                  </ul>
                  <a href="#" className="inline-flex items-center gap-2 text-primary hover:underline mt-4 font-medium">
                    <FileText className="w-4 h-4" />
                    View sample lesson →
              ...
              >
                ...
                <AccordionContent className="pt-2 pb-4 space-y-3">
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-relaxed">
                    ...
                    <li>Sanctions and disciplinary proceedings</li>
                    <li>Advertising, contingent fees, written advice</li>
                    <li>Recordkeeping and client communications</li>
                  </ul>
                  <a href="#" className="inline-flex items-center gap-2 text-primary hover:underline mt-4 font-medium">
                    <FileText className="w-4 h-4" />
                    View sample lesson →
