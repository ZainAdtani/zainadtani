...
function FeatureCard({ icon, title, body }: { icon: string; title: string; body: string }) {
  return (
    <div className="bg-[#0A0F1A] border border-[#2C4A73] rounded-2xl p-6 flex gap-4 items-start hover:border-[#447BBE]/40 transition-colors">
...
export default function Services() {
  return (
    <div className="min-h-screen bg-[#0A0F1A]">
      ...
      <section className="bg-[#0A0F1A] py-16 border-t border-[#2C4A73]">
