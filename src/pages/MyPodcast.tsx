...
export default function MyPodcast() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden rounded-3xl border bg-gradient-to-b from-green-600/15 via-green-500/10 to-background p-8 md:p-10">
        <div className="relative z-10 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl">Zain's World Podcast</h1>
