...
try {
  // @ts-expect-error - this file is generated by a script
  IMPORTED_BOOKS = require('@/public/data/books_notionsync.json');
  console.log('✅ Imported books_notionsync.json');
} catch (e) {
  console.warn('⚠ Could not import books_notionsync.json, using LOCAL_BOOKS only', e);
}
